    ...
    return (
        <div className="w-full flex flex-row justify-start">
            <div className="w-full flex flex-col items-start">
                <p className="break-words max-w-[600px] py-[8px] px-[16px] bg-white rounded-t-[10px] rounded-br-[10px] text-black text-[12px] lg:text-[14px]">{body}</p>
    ...
    return (
        <div className="w-full flex flex-row justify-end">
            <div className="w-full flex flex-col items-end">
                <p className="break-words max-w-[600px] py-[8px] px-[16px] bg-brand-inv rounded-t-[10px] rounded-bl-[10px] text-white text-[12px] lg:text-[14px]">{body}</p>
