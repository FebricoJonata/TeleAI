...
export default function BaseSidebar() {
    ...
    return (
        <div className='relative'>
            ...
            <aside className={`z-20 bg-brand-semi-inv w-[280px] max-h-screen h-screen flex flex flex-col jusify-start items-start py-[24px] transition-all duration-300 lg:translate-x-0 ${isExpanded ? 'translate-x-0' : '-translate-x-full'}`}>
